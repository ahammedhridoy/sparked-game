          ...
          <div className="pricing-grid">
            ...
            <div className="plan-card">
              ...
              <div className="plan-price">
                <span className="plan-currency">$</span>4.99
                <span className="plan-period">/mo</span>
              </div>
              <ul className="plan-features">
                <li>
                  <span className="check">✓</span> Full VIP access
                </li>
                <li>
            ...
            <div className="plan-card plan-card--featured">
              ...
              <div className="plan-price">
                <span className="plan-currency">$</span>27
                <span className="plan-period">/6mo</span>
                <div className="plan-subprice">$4.50 / month</div>
              </div>
              <ul className="plan-features plan-features--featured">
                <li>
                  <span className="check">✓</span> Save vs monthly
                </li>
                <li>
                  <span className="check">✓</span> Priority support
                </li>
                <li>
                  <span className="check">✓</span> All VIP features
                </li>
              </ul>
              {user ? (
                <SubscribeButton
            ...
            <div className="plan-card">
              ...
              <div className="plan-price">
                <span className="plan-currency">$</span>48
                <span className="plan-period">/yr</span>
                <div className="plan-subprice">$4.00 / month</div>
              </div>
              <ul className="plan-features">
                <li>
                  <span className="check">✓</span> Best price per month
                </li>
                <li>
                  <span className="check">✓</span> VIP features + updates
                </li>
                <li>
                  <span className="check">✓</span> Support the project
                </li>
              </ul>
              {user ? (
                <SubscribeButton
      ...
      {showLoginPrompt && (
        ...
        >
          <div className="ios-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="ios-modal-subtitle">
              Log in with Google to complete your subscription.
            </p>
            <div
              style={{
                display: "flex",
